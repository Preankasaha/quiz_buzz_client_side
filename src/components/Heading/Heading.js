    ...
    return (
        <div className='md:flex flex-row w-100% gap-x-48 justify-center items-center  text-blue-800 my-8 bg-amber-400 p-3.5'>
            ...
            <div className="img-container">
                <img className='h-80 rounded-xl lg:w-full' src="https://images.unsplash.com/photo-1606326608690-4e0281b1e588?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" data-aos="fade-left"
                    data-aos-easing="ease-out-cubic"
